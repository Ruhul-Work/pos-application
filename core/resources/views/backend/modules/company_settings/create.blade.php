...
@section('meta')
    <title>Create Company Setting </title>
@endsection
...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            ...
            <p class="fw-semibold mb-0">Create Setting</p>
        </div>
    ...
    <form action="{{ route('company_setting.store') }}" id="edit_brand" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-16">
                                ...
                                <select name="warehouse_id" class="form-control js-s2-ajax"
                                    data-url="{{ route('org.btypes.select2') }}"
                                    data-placeholder="Select business type" required></select>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            window.S2.auto(); //live search select2
