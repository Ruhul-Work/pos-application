...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            ...
            <p class="fw-semibold mb-0">Create new customer</p>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="text" class="form-control" id="alternate_phone" name="alternate_phone" placeholder="optional">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Date of Birth</label>
                                            <input type="date" class="form-control" id="birth_date" name="birth_date" placeholder="optional">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" class="form-control" min="0" id="address" name="postal_code">
                                        </div>
                                    </div>
