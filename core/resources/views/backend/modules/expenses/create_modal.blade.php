...
<div class="modal-body p-24" id="categoryCreateModal">
  <form id="categoryCreateForm" action="{{ route('expenses.store') }}" method="post" data-ajax="true" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-20">
        ...
        <select name="expense_category_id" id="categoryTypeSelect" class="form-control js-category-type-select"></select>
    ...
    <div class="row">
      <div class="col-md-6 mb-16">
        ...
        <input type="number" name="amount" min="0" class="form-control radius-8" placeholder="$512">
      ...
      <div class="col-md-6 mb-20">
        ...
        <input type="text" name="reference" class="form-control radius-8" placeholder="e.g. Dhaka Main">
    ...
    <div class="row">
      <div class="col-md-6 mb-20">
        ...
        <textarea name="description" rows="5" class="form-control radius-8" placeholder=""></textarea>
