<div data-modal-key="userEdit">
  ...
  <div class="modal-body p-24">
    <form id="userEditForm" data-ajax="true" method="post" action="{{ route('usermanage.users.update', $user->id) }}">
      @csrf
      @method('PUT')
      ...
      <div class="row">
        <div class="col-md-6 mb-16">
          ...
          <input type="text" name="name" class="form-control radius-8" value="{{ $user->name }}" required>
        ...
        <div class="col-md-6 mb-16">
          ...
          <input type="password" name="password" class="form-control radius-8" placeholder="Leave blank to keep">
        ...
        <div class="col-md-6 mb-16">
          ...
          <select id="editRole" name="role_id" class="form-control radius-8 js-select2" required>
            @if($user->role_id)
