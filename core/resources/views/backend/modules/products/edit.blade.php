...
@section('content')
    ...
    <form action="{{ route('brand.brands.update', $product->id) }}" id="product_form" method="post"
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <select name="unit_id" id="unit" class="form-control js-product-type-select">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <select name="color_id" id="color" class="form-control js-color-type-select">
                                            <option value="{{ $product->color_id }}" selected>{{ $product->color->name }}
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <select name="size_id" id="size" class="form-control js-color-type-select">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 ">
                                            ...
                                            <input type="number" min="0" class="form-control" name="cost_price"
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="number" min="0" class="form-control" name="mrp"
                                ...
                                <div class="row">
                                    <div class="my-3 text-xl text-white ">Image Section</div>
                                    <div class="col-lg-3 col-sm-6 col-12 ">
                                        <div class="mb-3">
...
@section('script')
    ...
    <script>
        ...
        $("#image").spartanMultiImagePicker({
            ...
            imageSrc: "https://example.com/path/to/old-image.jpg",
        ...
        $("#thumbnail_image").spartanMultiImagePicker({
            ...
            maxFileSize: '',
            dropFileLabel: "Drop Here",
            imageSrc: "{{ image($product->thumbnail_image) }}",
            onExtensionErr: function(index, file) {
                console.log(index, file, 'extension err');
                alert('Please only input png or jpg type file')
            },
        ...
        $("#size_chart_image").spartanMultiImagePicker({
            ...
            maxFileSize: '',
            dropFileLabel: "Drop Here",
            imageSrc: "{{ image($product->size_chart_image) }}",
            onExtensionErr: function(index, file) {
                console.log(index, file, 'extension err');
                alert('Please only input png or jpg type file')
            },
        ...
        $("#meta_image").spartanMultiImagePicker({
            ...
            maxFileSize: '',
            dropFileLabel: "Drop Here",
            imageSrc: "{{ image($product->meta_image) }}",
            onExtensionErr: function(index, file) {
                console.log(index, file, 'extension err');
                alert('Please only input png or jpg type file')
            },
