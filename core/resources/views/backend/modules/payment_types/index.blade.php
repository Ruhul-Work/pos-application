...
@section('content')
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <div>
      <h6 class="fw-semibold mb-0">Payment Type List</h6>
      <p class="m-0" >Manage Payment Types</p>
    </div>
    <ul class="d-flex align-items-center gap-2">
      ...
      <li>-</li>
      <li class="fw-medium">Payment Types</li>
    </ul>
  </div>
      ...
      <div class="actions-bar d-flex align-items-center gap-2 flex-wrap">
        ...
        @perm('paymentTypes.store')
            <button 
                ...
                <iconify-icon icon="ic:baseline-plus" class="text-xl"></iconify-icon>Add Payment-type
        </button>
        @endperm
      </div>
    </div>
...
@section('script')
  <script>
    var DATATABLE_URL = "{{ route('paymentTypes.list.ajax') }}";
