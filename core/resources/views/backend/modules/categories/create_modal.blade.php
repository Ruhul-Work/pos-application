...
<div class="modal-body p-24" id="categoryCreateModal">
    <form id="categoryCreateForm" action="{{ route('category.categories.store') }}" method="post" data-ajax="true"
        enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6 mb-20">
                <label class="form-label text-sm mb-8">Name <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control radius-8" placeholder="e.g. Dhaka Main"
            ...
            <div class="col-md-6 mb-20">
                ...
                <input type="text" name="slug" class="form-control radius-8" placeholder="" required
                    id="slugInput">
