...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            ...
            <p class="fw-semibold mb-0">Create new Supplier</p>
        </div>
        ...
        <div class="text-end w-100 ">
            <a href="{{ route('supplier.index') }}" class="btn btn-secondary bg-dark "><i data-feather="arrow-left"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="text" class="form-control" min="0" id="address"
                                                name="postal_code">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row" id="supplier_image"></div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#supplier_image").spartanMultiImagePicker({
                fieldName: 'image',
                maxCount: 1,
                rowHeight: '200px',
                groupClassName: 'col',
