    ...
    <div class="card basic-data-table">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="actions-bar d-flex align-items-center gap-2 flex-wrap">
                ...
                @perm('brand.brands.store')
                    <a href="{{ route('brand.brands.create') }}" class="d-flex btn btn-primary btn-sm px-12 py-8 radius-8 "
                        data-size="lg" data-onsuccess="BranchesIndex.onSaved">
                        <iconify-icon icon="ic:baseline-plus" class="text-xl"></iconify-icon>Add Brand
                        </a>
                    @endperm
            </div>
        </div>
...
@section('script')
    <script>
        var DATATABLE_URL = "{{ route('brand.brands.list.ajax') }}";
